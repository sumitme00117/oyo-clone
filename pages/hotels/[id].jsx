...
const SingleHotel = ({hotel}) => {
  ...
  return (
    ...
    <div className="w-7/12 mx-auto my-10">
      <Image src={hotel?.banner} alt="hotel" width={2000} height={2000} className="w-full h-large-box my-5"/>
      <div className="">
        ...
        </ul>
        {
          ...
          ) : <span className="text-2xl">Please <Link href={"/login"} className="text-blue-500">Login</Link> to get offers</span>
        }
      </div>
    </div>
    </>
